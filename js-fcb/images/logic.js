...
function slideLeft(){
	...
	for(let r=0; r<rows; r++){
		...
		// After merging, the position and the value of the tiles have changed, thus it follows that the id, the number to be displayed, and the color of the tile must be changed.
...
function slideUp(){
	...
	for(let c=0; c<columns; c++){
		...
		// Using this loop we are able to update the id and color of all the tiles, from the first column of a row to its last column, and because of the upper loop, not just single row will be updated, but all the rows.
		for(let r=0; r<rows; r++){
